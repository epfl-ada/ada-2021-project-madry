...
data_selection <- function(df2, names, personality){
  ...
  mymap <- heatmaply(normalize(my_data2),  xlab = "Personality Features",
                     ylab = "Politicians")
