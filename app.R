...
# Load the personality data for politicians
df = read.csv("concats")

# select the personality and name of politicians
...
# Select data based on the input of politician name and personality trait
